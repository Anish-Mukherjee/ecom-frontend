            ...
            <header className="shadow-sm">
                <div className="flex items-center justify-between h-16 max-w-screen-xl px-4 mx-auto">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <form className="hidden mb-0 lg:flex">
                            <div className="relative">
                                ...
                                <button className="absolute inset-y-0 right-0 p-2 mr-px text-gray-600 rounded-r-lg" type="submit">
                    ...
                    <nav className="items-center justify-center hidden space-x-8 text-sm font-medium lg:flex lg:flex-1 lg:w-0">
                        ...
                        <Link class="text-gray-900" to='/about'>About</Link>
                        <Link class="text-gray-900" to='/products'>Products</Link>
                        <Link class="text-gray-900" to='/contact'>Contact</Link>
                    ...
                    <div className="items-center hidden space-x-4 lg:flex">
                        <a className="px-5 py-2 text-sm font-medium text-gray-600 bg-gray-100 rounded-lg" href=""> Log in </a>
